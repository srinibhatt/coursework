...
--alternatively use load script
--usage call generate_sample_data(total_event_records,total_spectator_records); inserts 100 event,100 spectator , 10000 ticket records, 1000 cancel records
set search_path = cs2, public;
call generate_sample_data(100,100);
